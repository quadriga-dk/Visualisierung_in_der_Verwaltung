...
| Tab | Inhalt |
|---|---|
| **Startseite** | Gesamtübersicht Baumbestand; filterbar nach Bezirk |
| **Karte** | Interaktive Karte: Anteil bewässerter Bäume je Bezirk |
| **Zeitverlauf** | Bewässerungsmenge nach Pflanzjahr |
